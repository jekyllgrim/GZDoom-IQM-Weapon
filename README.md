Example project for GZDoom showcasing the use of the [IQM 3D model format](https://www.zdoom.org/wiki/MODELDEF#OBJ) with [decoupled animations](https://zdoom.org/wiki/SetAnimation) in a weapon.
